...
<c:set var="cart" value="${sessionScope['scopedTarget.cartService']}" />
		<div style="padding: 20px 0px 20px 0px; margin-top: -10px; position: relative;" style="justify-content: center;">
			<div id="myCarousel" class="carousel slide" data-ride="carousel" >
				  ...
				  <div class="carousel-inner" style="height:500px;" >
					    <div class="item active">
					      <img src="/static/images/slideshow/slider1.jpg" alt="Los Angeles" style="width: 100%">
					    </div>
					
					    <div class="item">
					      <img src="/static/images/slideshow/slider2.png" alt="Chicago" style="width: 100%">
					    </div>
					
					    <div class="item">
					      <img src="/static/images/slideshow/slider3.png" alt="New York" style="width: 100%; ">
					    </div> 
				  </div>
				  ...
				  <a class="right carousel-control" href="#myCarousel" data-slide="next" style="margin-right:-1px;">
	...
	<div class="gia-soc" style="margin-top: 30px">
		<div style="background-color: rgb(206, 18, 18); width: 100%; height: auto; margin-top: -10px; font-weight: bold; padding: 15px">
